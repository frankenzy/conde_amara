                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">{{ _('title') }}</p>
                            <h4 class="mb-0">{{ _('V.A.R') }}</h4>
                        </div>
                    </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
            <div class="card z-index-2 ">
                ...
                <div class="card-body">
                    <h6 class="mb-0 ">Liste de projet</h6>
                    <p class="text-sm ">voir la liste des derniers projets</p>
                    <hr class="dark horizontal">
                    <div class="d-flex ">
                        <span class="material-icons">
                            visibility
                        </span>
                        <a href="{{ Route('projet.index') }}" class="mb-0 text-sm">Decouvrir </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
            <div class="card z-index-2  ">
                ...
                <div class="card-body">
                    <h6 class="mb-0 ">Porteur de projet </h6>
                    <p class="text-sm ">Nos porteur de projet de la semaine</p>
                    <hr class="dark horizontal">
                    <div class="d-flex ">
                        <span class="material-icons">
                            visibility
                        </span>
                        <a href="{{ Route('porteurProjet.index') }}" class="mb-0 text-sm"> Decouvrir </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4 mt-4 mb-3">
            <div class="card z-index-2 ">
                ...
                <div class="card-body">
                    ...
                    <p class="text-sm ">Les fournisseur du moment</p>
                    <hr class="dark horizontal">
                    <div class="d-flex ">
                        <span class="material-icons">
                            visibility
                        </span>
                        <a href="{{ Route('fournisseur.index') }}" class="mb-0 text-sm">Decouvrir</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            ...
                            <p class="text-sm mb-0">
                                ...
                                <span class="font-weight-bold ms-1">{{ _(30) }}</span> du mois
                            </p>
                        </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100">
                <div class="card-header pb-0">
                    <h6>Tendance du moment</h6>
                    <p class="text-sm">
                        <i class="fa fa-arrow-up text-success" aria-hidden="true"></i>
                        <span class="font-weight-bold">24%</span> {{ _('type de projet') }}
                    </p>
                </div>
